...
n# Load a map of Chicago into R:
chicago = get_map(location = "chicago", zoom = 11)
corning = get_map(location = "corning", zoom = 13)
...
LatLonCounts3 = subset(LatLonCounts, Freq > 0)
str(LatLonCounts3)
...
ggmap(chicago) + geom_tile(data=LatLonCounts3, aes(x = Long, y = Lat, alpha=Freq), fill="red")
...
murderMap$MurderRate = murderMap$GunOwnership / murderMap$Population * 100000
ggplot(murderMap, aes(x = long, y = lat, group = group, fill = MurderRate)) + geom_polygon(color = "black") + scale_fill_gradient(low = "black", high = "red", guide = "legend")
