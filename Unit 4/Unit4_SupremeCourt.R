...
StevensTree1 = rpart(Reverse ~ Circuit +
                      Issue +
                      Petitioner + 
                      Respondent + 
                      LowerCourt + 
...
StevensTree2 = rpart(Reverse ~ Circuit +
                       Issue +
                       Petitioner + 
                       Respondent + 
                       LowerCourt + 
...
set.seed(100)
StevensForest1 = randomForest(Reverse ~ Circuit + Issue + Petitioner + Respondent + LowerCourt + Unconst,
                              data = Train,
                              ntree=200, 
                              nodesize=25 )
